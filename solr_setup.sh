...
solr_config() {
	...
	# Important! Supplying -s "$solr_instance_home/data" is critical. It instantiates solr with the solr.xml stored at $solr_instance_home/data instead of the default at server/solr
